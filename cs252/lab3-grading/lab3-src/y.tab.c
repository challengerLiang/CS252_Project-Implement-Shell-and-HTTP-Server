...
#define LESS 266
#define GREAT_AMPERSAND 267
#define GREATGREAT_AMPERSAND 268
...
{
       0,     0,     3,     5,     7,    10,    12,    17,    19,    22,
      26,    28,    31,    34,    35,    37,    39,    41,    43,    46,
      47,    50,    53,    56,    59,    62,    64
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      18,    -1,    19,    24,    26,     7,    -1,     7,    -1,     1,
       7,    -1,    19,     9,    20,    -1,    20,    -1,    23,    21,
      -1,    21,    22,    -1,    -1,     3,    -1,     4,    -1,     3,
      -1,    25,    -1,    24,    25,    -1,    -1,     6,     3,    -1,
      11,     3,    -1,    12,     3,    -1,     8,     3,    -1,    13,
       3,    -1,    10,    -1,    -1
};
...
{
       0,   274,   274,   278,   279,   282,   286,   290,   291,   295,
     298,   302,   309,   310,   314,   338,   443,   452,   452,   452,
     455,   461,   465,   472,   480,   492,   496
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "SUBSHELL", "NOTOKEN", "GREAT",
  "NEWLINE", "GREATGREAT", "PIPE", "AMPERSAND", "LESS", "GREAT_AMPERSAND",
  "GREATGREAT_AMPERSAND", "$accept", "goal", "commands", "command",
  "simple_command", "pipe_opt", "command_and_args", "argument_list",
  "argument", "command_word", "iomodifier_list", "iomodifier_opt",
  "background_opt", YY_NULL
};
#endif
...
{
       0,     0,    16,     7,     0,     0,     3,     5,    19,    10,
      13,     8,     1,     4,     0,     0,     0,     0,     0,     0,
      26,    17,    11,    20,    23,     9,    21,    22,    24,    25,
      18,     0,    14,    15,    12,     6
};
...
{
      17,    -3,    -7,    -7,     1,    16,    -7,    -7,    -6,    -7,
      -7,    -7,    -7,    -7,     6,     8,    22,    23,    24,    25,
       2,    -7,    18,    -7,    -7,    -7,    -7,    -7,    -7,    -7,
      -7,    26,    -7,    -7,    -7,    -7
};
...
{
       6,     0,     8,     9,     7,    11,    12,    13,     6,     3,
       8,     3,    10,    11,    12,    13,     0,     1,     1,     3,
       3,     3,     4,     7,     7,     3,     3,     3,     3,    16,
      20,    -1,     5,     7
};
...
static const yytype_uint8 yystos[] =
{
      ...
      23,     7,     0,    17,     6,     8,     9,    11,    12,    13,
      24,    25,    21,     3,     3,    20,     3,     3,     3,    10,
      25,    26,     3,     4,    22,     7
};
...
#line 314 "shell.y"
    {
           ...
           count = 0;
           specialCase = 0;
	       expandWildcard(NULL, (yyvsp[(1) - (1)].string_val));
...
#line 461 "shell.y"
    {
		...
		Command::_currentCommand._inFile = (yyvsp[(2) - (2)].string_val);
	}
    break;
